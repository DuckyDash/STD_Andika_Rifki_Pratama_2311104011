...
int main() { 
    ...
    infotype m2 = {"Paul", "02", 'L', 3.4};
    infotype m3 = {"Dinda", "03", 'P', 3.2};
    infotype m4 = {"Lonzo", "04", 'L', 3.1};
    infotype m5 = {"Bibi", "05", 'P', 3.9};
    infotype m6 = {"Mike", "06", 'L', 3.8};
    infotype m7 = {"Julio", "07", 'L', 3.7};
    infotype m8 = {"Miguel", "08", 'L', 3.0};
